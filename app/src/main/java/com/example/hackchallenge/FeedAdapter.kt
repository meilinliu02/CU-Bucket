...
class FeedAdapter(private val feed : List<FeedPost>,private val sharedViewModel: SharedViewModel) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.feedLikes.text = feedPost.numLikes.toString()
        holder.feedSaves.text = feedPost.numSaves.toString()
        holder.feedUsername.text = feedPost.username
        holder.profilePic.setImageResource(R.drawable.profile)
        holder.postPic.setImageResource(R.drawable.cu)
        ...
        holder.saveButton.setOnClickListener{
            ...
            holder.saveButton.setImageResource(R.drawable.filled_save)
        }
...
//            Log.d("adapter", sharedViewModel.newBucketItem.value.toString() )
            holder.addbutton.setImageResource(R.drawable.full)
        }
